...
> 移动端click点击300ms延迟的问题，引入 fastclick

```
npn install fastclick --save
```

把 `fastclick` 第三方的包安装到项目的依赖之中，`--save` 的意思是不管是在开发环境中还是打包生产线上的代码，都要使用`fastclick`
